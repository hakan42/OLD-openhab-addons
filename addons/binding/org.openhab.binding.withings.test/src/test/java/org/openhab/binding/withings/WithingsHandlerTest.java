...
/**
 * Test cases for {@link WithingsHandler}. The tests provide mocks for supporting entities using Mockito.
 *
 * @author Hakan Tandogan - Initial contribution
 */
public class WithingsHandlerTest extends JavaTest {
    ...
    public void setUp() {
        initMocks(this);
        handler = new WithingsHandler(thing);
