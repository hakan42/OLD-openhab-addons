...
import org.openhab.binding.withings.internal.WithingsConfiguration;
...
/**
 * The {@link WithingsHandler} is responsible for handling commands, which are
 * sent to one of the channels.
 *
 * @author Hakan Tandogan - Initial contribution
 */
@NonNullByDefault
public class WithingsHandler extends BaseThingHandler {

    private final Logger logger = LoggerFactory.getLogger(WithingsHandler.class);

    @Nullable
    private WithingsConfiguration config;

    public WithingsHandler(Thing thing) {
        super(thing);
    }
    ...
    public void initialize() {
        ...
        config = getConfigAs(WithingsConfiguration.class);
...
//
//                // Asked to handle 'Weight: 259.67 lb / 117.78 kg | Lean mass: 156.65 lb / 71.06 kg | Fat mass: 103.02 lb / 46.73 kg | Body fat: 39.67 % | April 25, 2017 at 08:42AM' on 'withings:scale:mine:raw-input-for-ifttt'
