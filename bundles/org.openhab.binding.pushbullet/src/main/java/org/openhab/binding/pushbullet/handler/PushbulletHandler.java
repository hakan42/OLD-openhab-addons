 ...
 */
package org.openhab.binding.pushbullet.handler;

import static org.openhab.binding.pushbullet.PushbulletBindingConstants.*;
...
import org.openhab.binding.pushbullet.action.PushbulletActions;
...
public class PushbulletHandler extends BaseThingHandler {
    ...
    @Nullable private PushbulletConfiguration config;
    ...
    public boolean sendPush(@Nullable String recipient, @Nullable String title, @Nullable String message, String type) {
        ...
        logger.debug("CFG Token '{}'", configuration.getToken());
        ...
        try {
            ...
            try (InputStream stream = new ByteArrayInputStream(request.getBytes(StandardCharsets.UTF_8))) {
                ...
                String pushAPI = configuration.getApiUrlBase() + "/pushes";
