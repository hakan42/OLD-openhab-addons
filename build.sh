...
# cd addons/binding/org.openhab.binding.withings
mvn clean verify -s ~/.m2/settings-nonexus.xml -B -V -Dspotbugs.skip=true -DskipTests -Dmaven.test.skip 1> .build.stdout 2> .build.stderr
