...
sub main
{
    ...
    # bundles/org.openhab.binding.withings/ESH-INF/config/config-description.xml
    # bundles/org.openhab.binding.withings/ESH-INF/binding/binding.xml
    # bundles/org.openhab.binding.withings/ESH-INF/thing/channels.xml
    # bundles/org.openhab.binding.withings/ESH-INF/thing/box.xml
    ...
    my $bridge_types_filename = "src/main/resources/ESH-INF/thing/bridge.xml";

    my $docBox = $parser->parsefile($bridge_types_filename);

    # print $docBox->toString . "\n";

    my $bridgeTypes = $docBox->getElementsByTagName ("bridge-type");
    my $n = $bridgeTypes->getLength;

    for (my $i = 0; $i < $n; $i++)
    {
        my $node = $bridgeTypes->item($i);

        $bridgeId = $node->getAttributeNode("id")->getValue;
        if ($bridgeId eq "api")
        {
            # print $node->toString . "\n";
    ...
    print EXTRACTED "# bridge...\n";
    print EXTRACTED "thing-type." . ${binding} . "." .${thingId} . ".label = " . $bridgeLabel . "\n";
    print EXTRACTED "thing-type." . ${binding} . "." .${thingId} . ".description = " . $bridgeDesc . "\n";
    print EXTRACTED "\n";

    print EXTRACTED "# things...\n";

    my $thing_types_filename = "src/main/resources/ESH-INF/thing/thing-types.xml";

    $docBox = $parser->parsefile($thing_types_filename);

    my $thingTypes = $docBox->getElementsByTagName ("thing-type");
    $n = $thingTypes->getLength;
    ...
    # print EXTRACTED "thing-type.config.withings.bot.name.label = Name of Bot\n";
    # print EXTRACTED "thing-type.config.withings.bot.name.description = Long description of Name of Bot\n";
    # print EXTRACTED "\n";
    # print EXTRACTED "thing-type.config.withings.bot.token.label = Token of Bot\n";
    # print EXTRACTED "thing-type.config.withings.bot.token.description = Long description of Token of Bot\n";
    ...
    # print EXTRACTED "channel-type.withings.recipient-channel.label = Recipient Channel\n";
    # print EXTRACTED "channel-type.withings.recipient-channel.description = Long description of Recipient Channel\n";
    # print EXTRACTED "\n";
    # print EXTRACTED "channel-type.withings.title-channel.label = Title Channel\n";
    # print EXTRACTED "channel-type.withings.title-channel.description = Long description of Title Channel\n";
    # print EXTRACTED "\n";
    # print EXTRACTED "channel-type.withings.message-channel.label = Message Channel\n";
    # print EXTRACTED "channel-type.withings.message-channel.description = Long description of Message Channel\n";
